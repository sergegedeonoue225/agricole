    ...
    <div class="container">
        <div class="profile-header">
            <div class="profile-info">
                <h1><?php echo htmlspecialchars($user['prenom'].' '.strtoupper($user['nom'])); ?></h1>
                <p class="highlight"><?php echo htmlspecialchars(number_format($user['solde'], 2, ',', ' ')); ?> €</p>
                <p><?php echo htmlspecialchars($user['type_compte']); ?></p>
            </div>
        </div>

        <div class="profile-details mt-4">
            <h2 style="font-weight: bold; text-align: center;">Effectuer un virement bancaire</h2>
            <br>
            <form action="server_virement.php" method="POST">
                <div class="mb-3">
                ...
                <input type="hidden" class="form-control" id="statut" name="statut" value="en attente">
