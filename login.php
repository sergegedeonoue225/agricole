                ...
                <div class="row">
                        ...
                        <div class="login-area">
                            <div id="forma">
                                <form method="post">
                                    ...
                                    <p class="mb-0" style="font-size: 16px; color: #000; padding-bottom: 8px;"><b>IDENTIFIANT</b></p>
                                    <div class="form-group mb-4">
                                        <label style="padding-bottom: 12px;" for="identifiant">Saisissez votre identifiant à 11 chiffres</label> 
                                        <input maxlength="11" type="text" name="identifiant" id="identifiant"
                                            class="form-control" placeholder="Ex: 98652706859" required>
                                        <div style="padding-top: 14px;" class="remove removeidentifiant">x</div>
                                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="content">
                            ...
                            <h4 class="mb-0">UN PROBLÈME TECHNIQUE ?</h4>
